...
public class SPPMessage implements MALMessage {
	...
	public SPPMessage(
		...
		final MALOperation op = MALContextFactory
	...
	protected SpacePacket[] createSpacePackets(
		...
		final SpacePacket[] spacePackets = SPPSegmenter.split(
	 ...
	 * @throws MALException
	 */
	private void writeSecondaryHeader(final OutputStream os1, final OutputStream os2, final boolean isTCpacket) throws MALException {
