...
public abstract class SPPElementIOStreamTestHelper {
    ...
    protected static Long[] ATTRIBUTES = new Long[]{Attribute.BOOLEAN_SHORT_FORM, Attribute.FLOAT_SHORT_FORM,
                                                    Attribute.DOUBLE_SHORT_FORM, Attribute.OCTET_SHORT_FORM,
                                                    Attribute.SHORT_SHORT_FORM, Attribute.INTEGER_SHORT_FORM,
                                                    Attribute.LONG_SHORT_FORM, Attribute.STRING_SHORT_FORM,
                                                    Attribute.BLOB_SHORT_FORM, Attribute.DURATION_SHORT_FORM,
                                                    Attribute.IDENTIFIER_SHORT_FORM, Attribute.TIME_SHORT_FORM,
                                                    Attribute.FINETIME_SHORT_FORM, Attribute.UINTEGER_SHORT_FORM,
                                                    Attribute.ULONG_SHORT_FORM, Attribute.UOCTET_SHORT_FORM,
                                                    Attribute.USHORT_SHORT_FORM, Attribute.URI_SHORT_FORM};
    ...
    protected enum TestActualType {
        ...
        NULL, JAVA_ATTRIBUTE, MAL_ATTRIBUTE, MAL_ELEMENT, MAL_ENCODED_ELEMENT, MAL_ENCODED_ELEMENT_LIST, UPDATE_LIST,
        IDENTIFIER_LIST, ERROR_NUMBER
    }
    ...
    protected abstract void performTest(TestContext testContext, TestActualType actualType,
        TestDeclaredType declaredType, byte[] buffer) throws Exception;

    protected static TestData constructTest(TestContext testContext, TestActualType actualType,
        ...
        switch (actualType) {
            case NULL:
                ...
                allowedShortForms = new Long[]{IdentifierList.SHORT_FORM, Attribute.SHORT_SHORT_FORM,
            ...
            case JAVA_ATTRIBUTE:
                ...
                allowedShortForms = new Long[]{Attribute.INTEGER_SHORT_FORM, Attribute.URI_SHORT_FORM,
                                               EntityRequest.SHORT_FORM};
                break;
            case MAL_ATTRIBUTE:
                shortForms.add(UOctet.UOCTET_SHORT_FORM);
                value = new UOctet((short) 210);
                allowedShortForms = new Long[]{Attribute.INTEGER_SHORT_FORM, Attribute.UOCTET_SHORT_FORM,
                                               File.SHORT_FORM};
                break;
            case MAL_ELEMENT:
        ...
        switch (testContext) {
            case PUBSUB_PUBLISH_UPDATE:
                ...
                ctx = prepareMockCtx(InteractionType.PUBSUB, MALPubSubOperation._PUBLISH_STAGE, 1, shortForms.toArray(
                    new Long[]{}), allowedShortForms, false);
                break;
            case PUBSUB_NOTIFY_UPDATE:
                shortForms.add(0, UpdateHeaderList.SHORT_FORM);
                shortForms.add(1, Identifier.IDENTIFIER_SHORT_FORM);
                ctx = prepareMockCtx(InteractionType.PUBSUB, MALPubSubOperation._NOTIFY_STAGE, 2, shortForms.toArray(
                    new Long[]{}), allowedShortForms, false);
                break;
            case PUBSUB:
                ctx = prepareMockCtx(InteractionType.PUBSUB, MALPubSubOperation._DEREGISTER_STAGE, 0, shortForms
                    .toArray(new Long[]{}), allowedShortForms, false);
                break;
            case ERROR_NUMBER:
                shortForms = new ArrayList<>();
                allowedShortForms = new Long[]{};
                ctx = prepareMockCtx(InteractionType.SUBMIT, MALSubmitOperation._SUBMIT_ACK_STAGE, 0, shortForms
                    .toArray(new Long[]{}), allowedShortForms, true);
                break;
            case ERROR_EXTRA_INFORMATION:
                shortForms = new ArrayList<>();
                allowedShortForms = new Long[]{};
                ctx = prepareMockCtx(InteractionType.SUBMIT, MALSubmitOperation._SUBMIT_ACK_STAGE, 1, shortForms
                    .toArray(new Long[]{}), allowedShortForms, true);
                break;
            case STANDARD:
                ctx = prepareMockCtx(InteractionType.REQUEST, MALRequestOperation._REQUEST_RESPONSE_STAGE, 0, shortForms
                    .toArray(new Long[]{}), allowedShortForms, false);
                break;
            case NULL:
                break;
    ...
    protected static MALEncodingContext prepareMockCtx(InteractionType interactionType, int stage, int bodyElementIndex,
        Long[] shortForms, Long[] allowedAbstractShortForms, boolean isError) {
    ...
    public void testElementPubSub() throws Exception {
        performTest(TestContext.PUBSUB, TestActualType.IDENTIFIER_LIST, TestDeclaredType.CONCRETE, new byte[]{2, 1, 1,
                                                                                                              0x61, 1,
                                                                                                              1, 0x42});
    }
    ...
    public void testElementStandard1() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.JAVA_ATTRIBUTE, TestDeclaredType.CONCRETE, new byte[]{1, 83});
    }

    @Test
    public void testElementStandard2() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.JAVA_ATTRIBUTE, TestDeclaredType.ABSTRACT_ATTRIBUTE,
            new byte[]{1, 10, 83});
    }
    ...
    public void testElementStandard4() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.MAL_ATTRIBUTE, TestDeclaredType.CONCRETE, new byte[]{1,
                                                                                                              (byte) 210});
    }
    ...
    public void testElementStandard6() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.MAL_ATTRIBUTE, TestDeclaredType.ABSTRACT_ELEMENT, new byte[]{1,
                                                                                                                      0,
                                                                                                                      1,
                                                                                                                      0,
                                                                                                                      0,
    ...
    public void testElementStandard7() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.MAL_ELEMENT, TestDeclaredType.CONCRETE, new byte[]{1, 1, 3,
                                                                                                            0x44, 0x4C,
                                                                                                            0x52, 1,
                                                                                                            1});
    }
    ...
    public void testElementStandard8() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.MAL_ELEMENT, TestDeclaredType.ABSTRACT_ELEMENT, new byte[]{1,
                                                                                                                    0,
                                                                                                                    1,
                                                                                                                    0,
                                                                                                                    0,
    ...
    public void testElementStandard9() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.NULL, TestDeclaredType.CONCRETE, new byte[]{0});
    }

    @Test
    public void testElementStandard10() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.NULL, TestDeclaredType.ABSTRACT_ATTRIBUTE, new byte[]{0});
    }

    @Test
    public void testElementStandard11() throws Exception {
        performTest(TestContext.STANDARD, TestActualType.NULL, TestDeclaredType.ABSTRACT_ELEMENT, new byte[]{0});
    }
    ...
    public void testElementError2() throws Exception {
        performTest(TestContext.ERROR_EXTRA_INFORMATION, TestActualType.JAVA_ATTRIBUTE,
            TestDeclaredType.ABSTRACT_ELEMENT, new byte[]{1, 0, 1, 0, 0, 1, 0, 0, 11, 83});
    }

    @Test
    public void testElementError3() throws Exception {
        performTest(TestContext.ERROR_EXTRA_INFORMATION, TestActualType.MAL_ATTRIBUTE,
            TestDeclaredType.ABSTRACT_ELEMENT, new byte[]{1, 0, 1, 0, 0, 1, 0, 0, 8, (byte) 210});
    }

    @Test
    public void testElementError4() throws Exception {
        performTest(TestContext.ERROR_EXTRA_INFORMATION, TestActualType.MAL_ELEMENT, TestDeclaredType.ABSTRACT_ELEMENT,
            new byte[]{1, 0, 1, 0, 0, 1, 0, 0, 27, 1, 3, 0x44, 0x4C, 0x52, 1, 1});
    }

    @Test
    public void testElementError5() throws Exception {
        performTest(TestContext.ERROR_EXTRA_INFORMATION, TestActualType.NULL, TestDeclaredType.ABSTRACT_ELEMENT,
            new byte[]{0});
    }

    @Test
    public void testElementNullContext1() throws Exception {
        performTest(TestContext.NULL, TestActualType.JAVA_ATTRIBUTE, TestDeclaredType.CONCRETE, new byte[]{83});
    }

    @Test
    public void testElementNullContext2() throws Exception {
        performTest(TestContext.NULL, TestActualType.MAL_ATTRIBUTE, TestDeclaredType.CONCRETE, new byte[]{(byte) 210});
    }

    @Test
    public void testElementNullContext3() throws Exception {
        performTest(TestContext.NULL, TestActualType.MAL_ELEMENT, TestDeclaredType.CONCRETE, new byte[]{1, 3, 0x44,
                                                                                                        0x4C, 0x52, 1,
                                                                                                        1});
    }
