...
public class SPPTransport extends SPPBaseTransport<SpacePacket>
{
  ...
  public void init() throws MALException
  {
    ...
    final GENMessagePoller rcvr = new GENMessagePoller<>(this,
  ...
  @Override
  protected GENMessageSender createMessageSender(final GENMessage msg, final String remoteRootURI) throws MALException, MALTransmitErrorException
  {
