...
//        logger.log(Level.INFO, "Passed 0");

        if(url != null) {
//            logger.log(Level.INFO, "Passed 1.0");
            openBCMConnection();

//            logger.log(Level.INFO, "Passed 1.1");

            if (bcmConnection != null) {
//                logger.log(Level.INFO, "Passed 1.2");
                bcmConnection.sendFrame(frame);
//                logger.log(Level.INFO, "Passed 1.3");
            }
        /* If no BCM connection is present we have to do loopback locally */
        } else {
//            logger.log(Level.INFO, "Passed 2.0");
            frame.setTimestamp(timeSource.getTime() * 1000);
//            logger.log(Level.INFO, "Passed 2.1");
            deliverBCMFrame(frame);
//            logger.log(Level.INFO, "Passed 2.2");
