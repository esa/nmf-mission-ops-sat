...
import de.dlr.gsoc.mo.malspp.encoding.SPPElementOutputStream;
...
public class SPPElementOutputStreamTest extends SPPElementIOStreamTestHelper {
	...
	public void testWriteElementPubSubPublish() throws Exception {
		performTest(TestContext.PUBSUB_PUBLISH_UPDATE, TestActualType.UPDATE_LIST, TestDeclaredType.CONCRETE, new byte[]{
			3, 1, 3, 2, (byte) 0xAB, (byte) 0xCD, 0, 1, 2, 1, (byte) 0xEF});
	}

	@Test
	public void testWriteElementPubSubNotify1() throws Exception {
		performTest(TestContext.PUBSUB_NOTIFY_UPDATE, TestActualType.MAL_ENCODED_ELEMENT, TestDeclaredType.CONCRETE, new byte[]{
			4, 1, 8, 1, 13, 0, 1, 21});
	}

	@Test
	public void testWriteElementPubSubNotify2() throws Exception {
		performTest(TestContext.PUBSUB_NOTIFY_UPDATE, TestActualType.MAL_ENCODED_ELEMENT_LIST, TestDeclaredType.CONCRETE, new byte[]{
			4, 0, 1, 11, 1, 13, 1, 17});
	}
	...
	public void testWriteElementNullContext1() throws Exception {
		performTest(TestContext.NULL, TestActualType.MAL_ENCODED_ELEMENT, TestDeclaredType.CONCRETE, new byte[]{
			4, 1, 8, 1, 13, 0, 1, 21});
	}

	@Test
	public void testWriteElementNullContext2() throws Exception {
		performTest(TestContext.NULL, TestActualType.MAL_ENCODED_ELEMENT_LIST, TestDeclaredType.CONCRETE, new byte[]{
			4, 0, 1, 11, 1, 13, 1, 17});
	}
}
