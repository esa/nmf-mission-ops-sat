...
public abstract class BasePointingConfig {
  ...
  protected void readFromMap(Map<String, String> map) {
    sensorUpdateIntervalMsec = BigInteger
        .valueOf(strToLong(map.get("update_interval_msec"), DEFAULT_SENSOR_UPDATE_INTERVAL_MS));
    paTolerance.setPREALIGNMENT_ANGLE_TOLERANCE_RAD(strToFloat(map.get("pa_angle_tol_rad"), DEFAULT_PA_ANGLE_TOL_RAD));
    paTolerance.setPREALIGNMENT_ANGLE_TOLERANCE_PERCENT(
        strToFloat(map.get("pa_angle_tol_perc"), DEFAULT_PA_ANGLE_TOL_PERCENT));
    paTolerance.setPREALIGNMENT_ANGULAR_VELOCITY_TOLERANCE_RADPS(
        strToFloat(map.get("pa_angvel_tol_radps"), DEFAULT_PA_ANGLE_VEL_TOL_RADPS));
    paTolerance
        .setPREALIGNMENT_TARGET_THRESHOLD_RAD(strToFloat(map.get("pa_tgt_thd_rad"), DEFAULT_PA_TARGET_THRESHOLD_RAD));
    ...
    determinationMode = SEPP_IADCS_API_TARGET_POINTING_ATTITUDE_DETERMINATION_MODES
        .swigToEnum(strToInt(map.get("det_mode"), DEFAULT_DETERMINATION_MODE));
    ...
    kfParams.setATTITUDE_PROCESS_VARIANCE(
        strToFloat(map.get("attitude_process_variance"), DEFAULT_ATTITUDE_PROCESS_VARIANCE));
    kfParams.setSUN_MAG_MEASUREMENT_VARIANCE(
        strToFloat(map.get("sun_mag_measurement_variance"), DEFAULT_SUN_MAG_MEAS_VARIANCE));
    kfParams.setSTS_MEASUREMENT_VARIANCE(
        strToFloat(map.get("startracker_measurement_variance"), DEFAULT_STARTRACKER_MEAS_VARIANCE));
